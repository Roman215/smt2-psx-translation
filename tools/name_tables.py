...
DEMONS = [
 "Satan","Metatron","Kamael","Sariel","Kushiel","Ophanim","Raguel","Haniel","Tzaphkiel","Remiel",
 ...
 "Quetzalcoatl","Baek Yong","Maya","Kali","Ishtar","Durga","Kikuri-hime","Hariti","Taueret",
 ...
 "Nemhain","Aello","Celaeno","Ocypete","Bennu","Adept","Terminator","Gyrator","Temple Knight",
 "Executioner","Neophyte","Butcher","Yamata-no-Orochi","Vritra","Raja Naga","Otohime","Mizuchi",
 "Naga","Nozuchi","Hanuman","Ganesha","Jinn","Tengu","Haokah","Mercurius","Cerberus","Gdon","Selket",
...
SPELLS = [
 ...
 "Fire dmg, 1 foe","Stronger Agi","Agi, all foes","Stronger Maragi","Ice dmg; may FREEZE","Stronger Bufu","Bufu, all foes","Stronger Mabufu","Elec; may SHOCK","Stronger Zio",
 ...
 "Cures party ailments","Cures POISON, 1 ally","Cures PALYZE, 1 ally","Cures STONE, 1 ally","Revive 1/4 HP, 1 ally","Revive full HP, 1 ally","Sacrifice: full party HP","Map until new moon","Exit dungeon","Warp to last save",
 ...
 "HAPPY, all foes","SLEEP, all foes","PANIC, all foes","BIND, all foes","BAT, 1 foe","Fire, several foes","Ice, several foes","Dmg+POISON, group","Elec, several foes","Ice, 1 group",
 ...
 "Scratch+POISON, 2","Scratch+PALYZE, 2","Dmg+POISON, 1 foe","Dmg+PALYZE, group","Coil+BIND, 1 foe","Dmg+CLOSE, 1 foe","Hits 2; may PALYZE","Dmg+PALYZE, 1 foe","Dmg+CLOSE, all foes","Hits all; may FREEZE",
 ...
 "Fuse 2 same demons","LOST; battle ends","Heal 1/2 dmg dealt","Removes 1 foe","Heal 3x HP spent","-----","-----","-----","-----","-----",
 "Agi",
]
...
ITEMS = [
 ...
 "Thunder Whip","Crim. Nagamaki","Glamour Axe","Skip Hammer","Plasma Sword","Aqua Flail","Fire Standard","Vajra Club",
 ...
 "Kuchinawa","Houten Halberd","Deathbringer","Brionac","Gae Bolg","Gleipnir","Dagda's Club","Zuftaf Spear",
 "Ki Sword","Kogitsunemaru","Wind God Sword","Bolt God Sword","Bizen Osafune","Kotetsu","Kanesada","H. Nagamitsu",
 ...
 "Dancing Heels","Aero Jet","Cres. Greaves","Climb Shoes","Bell Greaves","Dragon Boots","Dawn Greaves","Blaze Greaves",
 "Panzer Leg","Jagd Leg","Sturm Leg","Tenma Greaves","Masakado Boots","Zipanium Leg","Jesus Leg","Kamraiterao",
 # 208-254 consumables
